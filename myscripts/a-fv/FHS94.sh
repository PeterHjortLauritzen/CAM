...
echo $PBS_ACCOUNT
unset caze
set caze=${cset}_${src}_${res}_a
/glade/scratch/$USER/$src/cime/scripts/create_newcase --case $scratch/$USER/$caze --compset $cset --res $res  --q $queue --walltime 02:30:00 --pecount $pecount  --project $PBS_ACCOUNT --compiler $compiler --run-unsupported
