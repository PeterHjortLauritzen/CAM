...
!==============================================================================
  ...
  subroutine diag_init_dry(pbuf2d)
    ...
    if (thermo_budget_history) then
       ...
       call cam_budget_em_register('dEdt_dme_adjust_physE','phAF','phAC','phy','dif',longname='dE/dt dry mass adjustment using physics E formula (phAF-phAC)')
       call cam_budget_em_register('dEdt_dme_adjust_dynE' ,'dyAF','dyAC','phy','dif',longname='dE/dt dry mass adjustment using dycore E (dyAF-dyAC)')
